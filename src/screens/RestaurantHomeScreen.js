        ...
        <View>
          ...
          <View style={styles.view2}>
            ...
            <View style={styles.view5}>
              <Text style={styles.text_6}>Collect</Text>
            ...
            <View style={styles.view8}>
              <Text style={styles.text_6}>Delivery</Text>
...
const styles = StyleSheet.create({
  ...
  text_6: {fontSize: 15, fontWeight: 'bold', color: colors.grey1},
  ...
  text7: {fontSize: 16, fontWeight: 'bold', color: 'black', marginTop: 5},
