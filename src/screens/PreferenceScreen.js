...
export default class PreferenceScreen extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      minimum_quantity:
        menuDetailedData[this.props.route.params.index].minimum_quantity,
      ...
      <View style={styles.container}>
        <ScrollView>
          <View style={styles.header}>
            <Image
              ...
              source={{
                uri: 'https://embed.widencdn.net/img/worldkitchen/lix24mtmcq/256x256px/1057399_CO_Tabletop_Silo-Scale_Square_Winter-Frost-White_Salad-Plate_2.jpg',
              }}
            />
          </View>
          ...
          <View style={styles.view4}>
            <View style={styles.view5}>
              ...
              <Text style={styles.text6}>Euro{price.toFixed(2)}</Text>
            </View>
          </View>
        ...
        <View style={styles.view17}>
          <View style={styles.view18}>
            <Text style={styles.text10}>Add 1 to Cart Euro78.21</Text>
          </View>
        </View>
      </View>
    );
